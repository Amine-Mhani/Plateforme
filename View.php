                            ...
                            <div class="card shadow mb-4" style="margin: auto 2% auto 2%">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <div class="submition" style="position: relative; margin-left: 70%;">
                                            <a href="valider.php?id= <?php echo $e->getId(); ?>" class="btn btn-success" style="margin:5%;">Valider</a>
                                            <a href="refuser.php?id= <?php echo $e->getId(); ?>" class="btn btn-danger">Refuser</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
