                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="ChangeMDP.php">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="pass2" placeholder="Repeat Password" oninput="verify()" required name="password2">
                                        <input type="text" id="msg" name="validity" hidden>
                                    </div>
                                </div>
                                <input type="submit" value="Réinitialiser" class="btn btn-primary btn-user btn-block"/>
                                <hr>
                            </form>
                            <div class="text-center">
                            </div>
